...
public class xlAdminServiceLogic extends xlServiceLogic
{
    ...
    public void service (HttpServletRequest request, HttpServletResponse response) 	throws ServletException, IOException
    {
		...
		//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Data from client" + buf);
		...
		SopLogger.debug(xlAdminServiceLogic.class, "action="+action);
...
//GetAllNeighborhoodTree()
		...
		SopLogger.debug(xlAdminServiceLogic.class, "xlAdminService::  userId:"+userId);
		...
		if (bwcon != null)
		{
			SopLogger.debug(xlAdminServiceLogic.class, "Successfully obtained authenticated Boardwalk Connection");
			try
			{
				switch(action)
				{
...
//						collabId = CreateCollaboration (bwcon, collabName, desc);
					...
					**/
					...
					case 9:						//CreateTable
						...
						SopLogger.write2EntitlementLog(" Table Creation  :: New Table ["+ tableName + "] for Collaboration Id ["+collabId + "] Successfuly By Admin User");
...
**/
					case 14:					//CreateNeighborhood
						...
						SopLogger.debug(xlAdminServiceLogic.class, "calling CreateNeighborhood");
						nhId = CreateNeighborhood(bwcon, nhName, parentNhId);
						SopLogger.debug(xlAdminServiceLogic.class, "Case 14 : Returned NHid=" + nhId);	
						if (nhId != -1)
						{	
							if (parentNhId > 0)
						...
						{
							//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Case14: New nhId=" + nhId);
					...
					case 17:					//CreateMembershipForNeighborhood
						...
						SopLogger.debug(xlAdminServiceLogic.class, "Case17: New Member id=" + userId);	
						if (memberId != -1)
						{	
							...
							SopLogger.write2EntitlementLog("New membership is created for user  [" + userId+"]");
						}
						break;
					...
					**/
					case 22:					//CreateNewUser
						...
						//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, bwcon +" " + user +" " +  extUser +" " +  pwd +" " +  firstname +" " +  lastname);
						SopLogger.debug(xlAdminServiceLogic.class, "Case22: New user id=" + userId);	
						if (userId != -1)
						{	
					...
					**/
					case 30:
						...
						try
						{
							...
							//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "allMembershipInfo : " + allMembershipInfo);
							//responseBuffer = "SUCCESS" + Seperator +  "The Neighborhood of " + nhId + "is \n" + tree + ContentDelimeter + nhId  ;
					...
					**/
					case 63:  			//Deactivate User
						...
						//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "test usermail="+usermail);
					...
					case 66:			//Force to Change Password
						...
						break;	
					case 67:  			//Remove Super User Access
						usermail = st.nextToken(Seperator);
						//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "test usermail="+usermail);
						status=deactivateAsSuperUser(connection,usermail);
						if (status==1)
						{
							responseBuffer = "SUCCESS" + Seperator +  "User " + usermail +" deactivated as super user successfully."   ;
						}
						else
						{
							responseBuffer = "FAILURE" + Seperator +  "User deactivation as super user failed. Please try again later."   ;
						}
						
						break;
					
					case 68:			//Add Super User Access
						usermail = st.nextToken(Seperator);
						//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "test usermail="+usermail);
						status=activateAsSuperUser(connection,usermail);
						if (status==1)
						{
							responseBuffer = "SUCCESS" + Seperator +  "User " + usermail +" added as super user successfully."   ;
						}
						else
						{
							responseBuffer = "FAILURE" + Seperator +  " added as Super user failed. Please try again later."   ;
						}
			...
			{
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "XXXXXXXX.........1");
				SopLogger.debug(xlAdminServiceLogic.class, "Boardwalk error code = " + bwe.getErrorCode());
				SopLogger.debug(xlAdminServiceLogic.class, "Boardwalk message = " + bwe.getMessage());
				SopLogger.debug(xlAdminServiceLogic.class, "Boardwalk potentioal solution = " + bwe.getPotentialSolution());
			...
			finally
			{
				...
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "XXXXXXXX.........Returning Response");
...
/**
	public BoardwalkConnection getBoardwalkConnection() throws IOException
	{
		...
		{
			if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "There is a Database connection problem.");
			commitResponseBuffer("There is a Database connection problem. \nContact Boardwalk Administrator for support.", res);
		}
		catch (BoardwalkException bwe)
		{
			if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Authentication/Connection Failed.");
			commitResponseBuffer("User Authentication/Connection Failed. \nYou have entered wrong User or Password. Try again.", res);
		}
		return bwcon;
	}
**/
	...
	public BoardwalkConnection getBoardwalkConnection(int userId) throws IOException
	{
		...
		try
		{
			...
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "userName ->:"+userName); // TODO:REMOVE
		...
		{
			SopLogger.debug(xlAdminServiceLogic.class, "There is a Database connection problem.");
			commitResponseBuffer("There is a Database connection problem. \nContact Boardwalk Administrator for support.", res);
		}
		catch (BoardwalkException bwe)
		{
			SopLogger.debug(xlAdminServiceLogic.class, "Authentication/Connection Failed.");
			commitResponseBuffer("User Authentication/Connection Failed. \nYou have entered wrong User or Password. Try again.", res);
		}
		finally
		{
...
*/
	...
	public boolean DeleteCollaboration (BoardwalkConnection bwcon, int collabId) throws  BoardwalkException
	{
		...
		{
			SopLogger.debug(xlAdminServiceLogic.class, e.toString());
			retVal = false;
		}
		return retVal;
	}
	...
	{
		if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Calling CollaborationManager.renameCollaboration collabId=" + collabId + " newName=" + newCollabName );
	...
	**/
	...
	{
		if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Calling CollaborationManager.renameWhiteboard wbId=" + wbId + " newWbName=" + newWbName );
	...
	**/
	...
	{
		SopLogger.debug(xlAdminServiceLogic.class, "Deleteing table " + tableId);
		boolean retVal = true;
		try
		{
			SopLogger.debug(xlAdminServiceLogic.class, "before .deelteTable call");
			BoardwalkTableManager.deleteTable(bwcon, tableId);
			SopLogger.debug(xlAdminServiceLogic.class, "after .deelteTable call");		}
		catch (Exception e)
		{
			SopLogger.debug(xlAdminServiceLogic.class, e.toString());
			retVal = false;
	...
	{
		if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Calling CollaborationManager.renameTable tableId=" + tableId + " newTableName=" + newTableName );
	...
	**/
	...
	public int CreateNeighborhood(BoardwalkConnection bwcon, String nhName,  int parentNhId) throws  BoardwalkException  
	{
		...
		SopLogger.debug(xlAdminServiceLogic.class, "Calling BoardwalkNeighborhoodManager.createNeighborhood nhName=" + nhName + " parentNhId=" + parentNhId );
		nhId = BoardwalkNeighborhoodManager.createNeighborhood(bwcon, nhName, false, parentNhId);
		SopLogger.debug(xlAdminServiceLogic.class, "After Calling BoardwalkNeighborhoodManager.createNeighborhood nhId=" + nhId);
		if (nhId == 0)
		{
			nhId = -1;
			SopLogger.debug(xlAdminServiceLogic.class, "Throwing exception...10016" ); 
			//throw new BoardwalkException( 10016 );
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "After Throwing exception...10016");			
		}
		return nhId;
	}
	...
	{
		SopLogger.debug(xlAdminServiceLogic.class, "Deleteing Neighborhood " + nhId);
		boolean retVal = true;
		try
		{
			SopLogger.debug(xlAdminServiceLogic.class, "before Calling BoardwalkNeighborhoodManager.deleteNeighborhood nhId=" + nhId );
			BoardwalkNeighborhoodManager.deleteNeighborhood(bwcon, nhId);
			SopLogger.debug(xlAdminServiceLogic.class, "after Calling BoardwalkNeighborhoodManager.deleteNeighborhood nhId=" + nhId );
		}
		catch (Exception e)
		{
			SopLogger.debug(xlAdminServiceLogic.class, e.toString());
	...
	{
		if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Calling CollaborationManager.renameNh nhId=" + nhId + " newNhName=" + newNhName );
	...
	**/
		...
		) throws BoardwalkException 
	{
		try
		{
			...
			while (nh0i.hasNext())
			{
				...
				printNH(bnn, -1);
				SopLogger.debug(xlAdminServiceLogic.class, "sb:\n" + sb.toString());
			}

		}
		catch (BoardwalkException bwe)
		{
			SopLogger.debug(xlAdminServiceLogic.class, "Error fetching neighborhood");
		}
		if (sb.length() > 0)
		{
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "Removing last character from SB");
    ...
    private static void printNH(BoardwalkNeighborhoodNode bnn, int parent)
    {
		...
		SopLogger.debug(xlAdminServiceLogic.class, bnn.getNeighborhood().getName() + " id=" + bnn.getNeighborhood().getId());
	...
	public static int CreateNewUser(BoardwalkConnection bwcon, String user, String extUser, String pwd, String firstname, String lastname) throws  BoardwalkException
	{
		...
		SopLogger.debug(xlAdminServiceLogic.class, "Successfully created user with id = " + userId);
		return userId;
	}
    ...
    public static String GetUserList(BoardwalkConnection bwcon) throws BoardwalkException 
	{
		...
		try
		{
			...
			while (ui.hasNext())
			{
				...
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, bu.getId() + ":" + bu.getUserName() + ":" + bu.getExtUserName() + ":" + bu.getFirstName() + ":" + bu.getLastName() + ":" + bu.getActive());
				//getExtUserName
	...
	throws SystemException
	{
        ...
        try
        {
			...
			SopLogger.debug(xlAdminServiceLogic.class, "before calling CALL_BW_GET_ALL_MEMBERSHIPS_INFO i.e. "  + CALL_BW_GET_ALL_MEMBERSHIPS_INFO);
			cs.execute();
            rs = cs.getResultSet();
			SopLogger.debug(xlAdminServiceLogic.class, "after calling CALL_BW_GET_ALL_MEMBERSHIPS_INFO");

			int memberId, userId, nhId, nhLevel, active; //Modified by Lakshman on 20180329 to fix the Issue Id: 14264
			String firstName, lastName, emailAddress;
			StringBuffer sb = new StringBuffer();

			SopLogger.debug(xlAdminServiceLogic.class, "before while rs loop");

            while ( rs.next() )
            {
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "inside while rs loop");
				...
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "sb: " + sb.toString());
			}
			SopLogger.debug(xlAdminServiceLogic.class, "outside while rs loop");
			...
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "sb before return: " + sb.toString());
			return sb.toString();

        }
        catch(SQLException sqlexception)
        {
			SopLogger.debug(xlAdminServiceLogic.class, sqlexception.toString());
        ...
        finally
        {
            try
            {
				...
				SopLogger.debug(xlAdminServiceLogic.class, "throwing  sqlexception1");
	...
	throws BoardwalkException
	{
		...
		SopLogger.debug(xlAdminServiceLogic.class, "Successfully created Membership for User:" + userId + " under Nh:" + nhId);
		return memberId;		
	}
	...
	{
		SopLogger.debug(xlAdminServiceLogic.class, "Deleteing Membership " + memberId);
		boolean retVal = true;
		try
		{
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "before Calling BoardwalkNeighborhoodManager.deleteNeighborhood nhId=" + memberId );
			BoardwalkNeighborhoodManager.deleteMember(bwcon, memberId);
			//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "after Calling BoardwalkNeighborhoodManager.deleteNeighborhood nhId=" + memberId );
		}
		catch (Exception e)
		{
			SopLogger.debug(xlAdminServiceLogic.class, e.toString());
		...
		) throws BoardwalkException 
	{
		try
		{
			...
			SopLogger.debug(xlAdminServiceLogic.class, "Sucessfully fetched the collab tree from the database");
			...
			SopLogger.debug(xlAdminServiceLogic.class, "Collaboration = " + bcn.getName());
			...
			while ( wvi.hasNext())
			{
				...
				SopLogger.debug(xlAdminServiceLogic.class, "\tWhiteboard = " + bwn.getName());
				...
				if (tvi.hasNext())
				{
					while (tvi.hasNext())
					{
						...
						SopLogger.debug(xlAdminServiceLogic.class, "\t\tTable = " + btn.getName());
		...
		{
			SopLogger.debug(xlAdminServiceLogic.class, "Collaboration of this Id does not exists.");
		...
		) throws BoardwalkException , SystemException
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				try
				{
					SopLogger.debug(xlAdminServiceLogic.class, "calling GetCollaborationTreeForNh for NH: " + nhId);
					CollabforNh = GetCollaborationTreeForNh(connection, bwcon, nhId);
					...
					SopLogger.debug(xlAdminServiceLogic.class, "CollabforNh for NH: " + nhId + " :: " + CollabforNh);
				...
				catch (Exception e)
				{
					...
					CollabforNh = CollabforNh + nhId + Seperator + " " + Seperator + " " + Seperator + " " + Seperator;
					CollabforNh = CollabforNh + " "  ;
					SopLogger.debug(xlAdminServiceLogic.class, "Exception:::::::" + CollabforNh);
				}
		...
		public static int deactivateUser(Connection connection , String usermail)
			{
				...
				try
					{	
						SopLogger.debug(xlAdminServiceLogic.class, "DEACTIVATE USER");
						//bwUserRequest.print();
						User u = UserManager.getUser(connection,  usermail);
						if (u != null && u.getId() > -1 )
						{
							SopLogger.debug(xlAdminServiceLogic.class, "DEACTIVATE USER" + u.getId() );
		...
		//remove as super user 04072022
			public static int deactivateAsSuperUser(Connection connection , String usermail)
			{
				...
				try
					{	
						...
						if (u != null && u.getId() > -1 )
						{
							SopLogger.debug(xlAdminServiceLogic.class, "remove as super user" + u.getId() );
							MemberManager.deactivateSuperUser( connection, u.getId() );
							return 1;
						}
						return 0;
					}
			...
			//add as super User 04072022
			public static int activateAsSuperUser(Connection connection , String usermail)
			{
	
				try
					{	
						SopLogger.debug(xlAdminServiceLogic.class, "ACTIVATE USER");
						//bwUserRequest.print();
						User u = UserManager.getUser(connection,  usermail);
						if (u != null && u.getId() > -1 )
						{
							SopLogger.debug(xlAdminServiceLogic.class, "add as super User" + u.getId() );
							MemberManager.activateSuperUser( connection, u.getId() );
							return 1;
						}
						return 0;
					}
		...
		public static int activateUser(Connection connection , String usermail)
			{
				...
				try
					{	
						...
						if (u != null && u.getId() > -1 )
						{
							SopLogger.debug(xlAdminServiceLogic.class, "ACTIVATE USER" + u.getId() );
		...
		) throws BoardwalkException 
	{
		try
		{
			...
			while (nhIter.hasNext())
			{
				...
				//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "0 level - " + nh0sb.toString());
				...
				if (!nh1Tree.isEmpty())
				{
					...
					while (nh1Iter.hasNext())
					{
						...
						//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "1 level - " + nh1sb.toString());
						...
						if (!nh2Tree.isEmpty())
						{
							...
							while (nh2Iter.hasNext())
							{
								...
								//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "2 level - " + nh2sb.toString());
								...
								if (!nh3Tree.isEmpty())
								{
									...
									while (nh3Iter.hasNext())
									{
										...
										//if (com.boardwalk.model.Sop.isDebugEnabled()) com.boardwalk.model.Sop.debug(xlAdminServiceLogic.class, "3 level - " + nh3sb.toString());
			...
			{
				SopLogger.debug(xlAdminServiceLogic.class, "Removing last character from bwNHInfosb");
				bwNHInfosb.deleteCharAt(bwNHInfosb.length()-1);
			}
			if (bwNHStructuresb.length() > 0)
			{
				SopLogger.debug(xlAdminServiceLogic.class, "Removing last character from bwNHStructuresb");
