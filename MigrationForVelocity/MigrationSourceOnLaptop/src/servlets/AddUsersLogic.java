...
public class AddUsersLogic extends xlServiceLogic

{
    public AddUsersLogic(AddUsers srv) {
        super(srv);
    }
		   ...
		   try
			{
				...
				{
					commitResponseBuffer("Success:" + "result" + xlServiceLogic.Seperator + result + xlServiceLogic.Seperator + "tableId" + xlServiceLogic.Seperator + tableId, res);	// added by Prem Pawar on 05/22/12 for FirstName/LastName of User
				}
				else
				{
					commitResponseBuffer("Failure:" + "result" + xlServiceLogic.Seperator + result + xlServiceLogic.Seperator + "tableId" + xlServiceLogic.Seperator + tableId, res);	// added by Prem Pawar on 05/22/12 for FirstName/LastName of User
