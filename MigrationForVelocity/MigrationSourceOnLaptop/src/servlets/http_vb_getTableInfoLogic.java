...
public class http_vb_getTableInfoLogic extends xlServiceLogic
{
    ...
    public http_vb_getTableInfoLogic(http_vb_getTableInfo srv) {
        super(srv);
    }
		 ...
		 try
	        {
				...
				while ( wrkstr != null && !wrkstr.trim().equals (""))
				{
					...
					tablefield = tbl.nextToken (xlServiceLogic.ContentDelimeter);
