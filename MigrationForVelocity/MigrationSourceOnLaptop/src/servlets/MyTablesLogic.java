...
public class MyTablesLogic  extends BWServletLogic
{
    ServletContext sc;
    ...
    public MyTablesLogic(HttpServlet srv) {
        super(srv);
    }
...
//		String redirectURL = "/MyTables?tableId="+tableId+"&wbid="+wbid+"&ViewPreference="+ViewPreference+"&action=editTable";
		try
		{
			...
			in.close();
//			utilities.sendRedirect(req.getContextPath() + redirectURL);
			String redirectURL = "/MyTables?tableId="+new Integer(tableId)+"&wbid="+wbid+"&ViewPreference="+ViewPreference+"&action=editTable";
			res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
		}
        catch ( Exception e )
        {
           e.printStackTrace();
...
//			e.printStackTrace();
//		}
     String redirectURL = ("/MyTables?tableId="+new Integer(a_table_id)+"&wbid="+new Integer(wbid)+"&ViewPreference="+ViewPreference+"&action=editTable").replaceAll("\\n|\\r","");
     res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
    }
...
//		DefaultHTTPUtilities utilities=new DefaultHTTPUtilities();
		String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+
				"&tableName="+tableName+
				"&ViewPreference="+ViewPreference+
				"&action=editColumnAccess").replaceAll("\\n|\\r","");
//		try {
//			utilities.sendRedirect(req.getContextPath() + redirectURL);
//		}  catch (AccessControlException e) {
//			// TODO Auto-generated catch block
...
//			sbRetValue.append("^");
    ...
    throws ServletException, IOException
    {
		...
		int asOfTid = -1;
		if (asOfTidStr != null && !asOfTidStr.equals("null") && !asOfTidStr.equals(""))
		{
			asOfTid = Integer.parseInt(asOfTidStr);
		}

		int compTid = -1;
		if (compTidStr != null && !compTidStr.equals("null") && !compTidStr.equals(""))
		{
			compTid = Integer.parseInt(compTidStr);
		}

		long asOfDate = -1;
		if (asOfDateStr != null && !asOfDateStr.equals("null") && !asOfDateStr.equals(""))
		{
			System.out.println("asOfDate = " + asOfDateStr);
			asOfDate = Long.parseLong(asOfDateStr);
		}
		long compDate = -1;
		if (compDateStr != null && !compDateStr.equals("null") && !compDateStr.equals(""))
		{
...
//			int criteriaTableId = TableViewManager.getCriteriaTable(connection, tableId);
    ...
    throws ServletException, IOException
    {
		...
		String tableName = req.getParameter("tableName");
		System.out.println("tableAccessCommit = " +a_table_id + " name = " +tableName + " ViewPreference = " + ViewPreference);
     ...
     try
      {
		...
		req.setAttribute("tableId", new Integer(a_table_id));
		req.setAttribute("tableName", tableName);
		req.setAttribute("ViewPreference", ViewPreference );
...
//			e.printStackTrace();
//		}
		String redirectURL = ("/MyTables?tableId="+new Integer(a_table_id)+"&ViewPreference="+ViewPreference+"&action=editTable").replaceAll("\\n|\\r","");
		res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
    }
...
//				e.printStackTrace();
//			}
		  String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+"&ViewPreference="+ViewPreference+"&action=editTable").replaceAll("\\n|\\r","");
		  res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
    }
...
public void  commitCopyTable()
	...
	System.out.println("tableName : "+req.getParameter("tableName") );
	System.out.println("tableDescr : "+req.getParameter("tableDescr") );
...
//		}
        // Return to the edit table page
		    String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+"&wbid="+new Integer(wbid)+"&ViewPreference="+ViewPreference+"&action=editTable&designValues="+designValues).replaceAll("\\n|\\r","");
			res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
    }
...
//	DefaultHTTPUtilities utilities=new DefaultHTTPUtilities();
	String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+"&wbid="+new Integer(wbid)+"&ViewPreference="+ViewPreference+"&action=editTable").replaceAll("\\n|\\r","");
...
//	 	DefaultHTTPUtilities utilities=new DefaultHTTPUtilities();
	    String redirectURL = ("/MyTables?tableId="+tableId+"&wbid="+wbid+"&ViewPreference="+ViewPreference+"&action=editTable").replaceAll("\\n|\\r","");
//	    try {
//			utilities.sendRedirect(req.getContextPath() + redirectURL);
//		} catch (AccessControlException e) {
//			// TODO Auto-generated catch block
...
//        DefaultHTTPUtilities utilities=new DefaultHTTPUtilities();
   	    String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+"&ViewPreference="+ViewPreference+"&action=editTable&designValues="+designValues).replaceAll("\\n|\\r","");
   	 res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
   	    //        try
//        {
//            // return to table edit mode
...
//	DefaultHTTPUtilities utilities=new DefaultHTTPUtilities();
	String redirectURL = ("/MyTables?tableId="+new Integer(tableId)+"&ViewPreference="+ViewPreference+"&rowId="+rowId+"&action=addRowUsingAForm").replaceAll("\\n|\\r","");
	res.sendRedirect((req.getContextPath() + redirectURL).replaceAll("\\n|\\r",""));
//	 try {
//		utilities.sendRedirect(req.getContextPath() + redirectURL);
//	} catch (AccessControlException e) {
...
//		"/Whiteboard?wbid="+wbid).forward(req,res);
    ...
    public void removeTable() throws ServletException, IOException
    {
		...
		tableId = Integer.parseInt(req.getParameter("tableId"));
        int wbid = Integer.parseInt(req.getParameter("wbid"));
        System.out.println("***/****Whiteboard ID : " + wbid);
		req.setAttribute("TableId", new Integer(tableId));
        Connection connection = null;
        TransactionManager tm = null;
		//updateTableDB();
