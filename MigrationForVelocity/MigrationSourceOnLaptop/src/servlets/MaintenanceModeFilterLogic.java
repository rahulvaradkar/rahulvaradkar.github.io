...
public class MaintenanceModeFilterLogic extends xlServiceLogic
{
	...
	public MaintenanceModeFilterLogic(MaintenanceModeFilter srv) {
		super(srv);
		this.maintenanceUrl = srv.maintenanceUrl;
		this.maintenanceGuiUrl = srv.maintenanceGuiUrl;
		this.password = srv.password;
		this.Comment = srv.Comment;
	}
