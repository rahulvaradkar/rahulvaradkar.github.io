...
BEGIN
	...
	INSERT INTO BW_DEPLOYED_PACKAGES
		(PACKAGE_NAME, SOURCE_SERVER, PACKAGE_CREATION_DATE, PACKAGE_DEPLOYED_DATE, PACKAGE_INFO)
		VALUES 
		(@PACKAGE_NAME, @SOURCE_SERVER, @PACKAGE_CREATION_DATE, GETUTCDATE(), @PACKAGE_INFO)
