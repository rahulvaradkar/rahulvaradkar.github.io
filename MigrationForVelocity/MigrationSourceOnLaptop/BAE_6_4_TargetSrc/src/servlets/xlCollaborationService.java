...
public class xlCollaborationService extends HttpServlet implements SingleThreadModel {

	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		xlCollaborationServiceLogic logic = new xlCollaborationServiceLogic(this);
