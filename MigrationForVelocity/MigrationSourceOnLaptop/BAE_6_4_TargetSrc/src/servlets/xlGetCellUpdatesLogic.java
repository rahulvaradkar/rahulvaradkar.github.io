...
public class xlGetCellUpdatesLogic extends xlServiceLogic
{
    ...
    public xlGetCellUpdatesLogic(xlGetCellUpdates srv) {
        super(srv);
    }
	...
	public void getCellVersions() throws ServletException, IOException
	{
		...
		try
		{
		    ...
		    boolean grey = false;
		    String currFormula = ""; //Modified by Lakshman on 20190906 to fix the Issue Id: 17310
		    while (i.hasNext())
		    {
