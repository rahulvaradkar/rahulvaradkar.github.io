...
public class MyCollaborationsLogic extends BWServletLogic
{
    //    BoardwalkDB bwdb;
    ...
    public MyCollaborationsLogic(HttpServlet srv) {
        super(srv);
    }
    ...
    HttpServletResponse response)throws ServletException, IOException {
        ...
        if ( action == null ) {
			...
			/***************Web Grid V1.0.3 Compatibility.***************/
			else if(context.equals("logout.html"))
				//this condition checks context parameter and redirect to logout page for webgrid 
				res.sendRedirect("WebUI/logout.html");
			/***************End Web Grid Logout Compatibility for V1.0.3***************/
			else
				res.sendRedirect("MyCollaborations");
