...
public final class MemberManager
{
    ...
    throws SystemException, BoardwalkException
    {
        ...
        try {
			...
			throw new BoardwalkException(10040); //Modified by Lakshman on 20181011 to fix the issue Id: 14324
        }
        finally {
            try {
...
static public void  activateUser(Connection connection, int userId)
{
 ...
 static public Vector getNonMembersWithUsername(Connection connection, int nhid)
        throws SystemException
        {
			...
			//Modified by Lakshman on 20180329 to fix the Issue Id: 14264, 14350- START
			...
			//Modified by Lakshman on 20180329 to fix the Issue Id: 14264, 14350 - END
    ...
    throws SystemException
    {
        String query = "select MEMBER.*, BW_USER.EMAIL_ADDRESS, BW_USER.EXTERNAL_USER_ID, NH.NAME "+
					   ...
					   "   and BW_USER.ACTIVE = 1 "+ //Modified by Lakshman on 20180329 to fix the Issue Id: 14350
