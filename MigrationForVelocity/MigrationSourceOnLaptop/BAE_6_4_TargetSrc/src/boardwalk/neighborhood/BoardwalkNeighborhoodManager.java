...
import com.boardwalk.table.*; //Added by Lakshman on 20181016 to fix the Issue Id: 14357
 ...
 public class BoardwalkNeighborhoodManager
 {
    ...
    */
    ...
    throws BoardwalkException
    {
        ...
        try
        {
			//Modified by Lakshman on 20181016 to fix the Issue Id: 14357
			...
			for (int i = 0; i < NhidsToBeDeleted.size() ;i++ )
			{
				...
				System.out.println("Value of deleteNhId: " + deleteNhId);
				NeighborhoodManager.purgeNeighborhood(connection.getConnection(),  deleteNhId);
			}
			tm.commitTransaction();
        }
        catch (Exception e)
