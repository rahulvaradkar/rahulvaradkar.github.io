...
//Added by Rahul Varadakar on  29-Nov-2013
...
//Added by Rahul Varadakar on  20-Mar-2015
			errorMessages.put( new Integer( 10020 ), new BoardwalkMessage( 10020, "REMOVE MEMBERSHIP EXCEPTION", 5 ,"There are BCP Objects referenced/created by this Member.",  "Can not delete the Membership"));
			errorMessages.put( new Integer( 10021 ), new BoardwalkMessage( 10021, "CREATE NEW RELATION EXCEPTION", 5 , "Failed to create new Relation." , "The Relation name must be Unique. Try again with different name." ));
			errorMessages.put( new Integer( 10022 ), new BoardwalkMessage( 10022, "UPDATE RELATION EXCEPTION", 5 , "Failed to Update existing Relation." , "Try again." ));
			errorMessages.put( new Integer( 10023 ), new BoardwalkMessage( 10023, "BRECT DEFINITION UPDATE EXCEPTION", 5 , "Failed to Update B-Rect Definition into Cuboid." , "Try again." ));
