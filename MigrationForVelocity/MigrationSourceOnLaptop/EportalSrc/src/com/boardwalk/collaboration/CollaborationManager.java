...
// Added by Rahul Varadkar on 30th November 2013.
	private static String CALL_BW_RENAME_COLLAB="{CALL BW_RENAME_COLLAB(?,?)}";
    private static String CALL_BW_RENAME_WB="{CALL BW_RENAME_WB(?,?)}";
    private static String CALL_BW_RENAME_TABLE="{CALL BW_RENAME_TABLE(?,?)}";
    private static String CALL_BW_RENAME_NH="{CALL BW_RENAME_NH(?,?)}";
...
// Added by Rahul Varadkar on 30-November-2013

    public static int renameCollaboration(
        Connection a_connection,
        int a_collabId,
        String a_newCollabName
        ) throws BoardwalkException
    {
        CallableStatement callablestatement = null;
		int retVal = a_collabId;

        try {
            callablestatement = a_connection.prepareCall(CALL_BW_RENAME_COLLAB);
            callablestatement.setInt(1,a_collabId);
            callablestatement.setString(2,a_newCollabName);
            int result = callablestatement.executeUpdate();
        }
        catch( SQLException sql ) 
		{
            ...
            if ( sql.getErrorCode() == 2627 ) 
			{
                throw new BoardwalkException( 10013, sql );
            }
            else 
			{
                sql.printStackTrace();
    ...
    public static int renameWhiteboard(
        Connection a_connection,
        int a_wbId,
        String a_newWbName
        ) throws BoardwalkException
    {
        ...
        try {
            callablestatement = a_connection.prepareCall(CALL_BW_RENAME_WB);
            callablestatement.setInt(1,a_wbId);
            callablestatement.setString(2,a_newWbName);
            int result = callablestatement.executeUpdate();
        }
        catch( SQLException sql ) 
		{
            ...
            if ( sql.getErrorCode() == 2627 ) 
			{
                throw new BoardwalkException( 10014, sql );
            }
            else 
			{
                sql.printStackTrace();
    ...
    public static int renameTable(
        Connection a_connection,
        int a_TableId,
        String a_newTableName
        ) throws BoardwalkException
    {
        CallableStatement callablestatement = null;
		int retVal = a_TableId;

        try {
            callablestatement = a_connection.prepareCall(CALL_BW_RENAME_TABLE);
            callablestatement.setInt(1,a_TableId);
            callablestatement.setString(2,a_newTableName);
            int result = callablestatement.executeUpdate();
        }
        catch( SQLException sql ) 
		{
            ...
            if ( sql.getErrorCode() == 2627 ) 
			{
                throw new BoardwalkException( 10015, sql );
            }
            else 
			{
                sql.printStackTrace();
        ...
        ) throws BoardwalkException
    {
        ...
        try {
            callablestatement = a_connection.prepareCall(CALL_BW_RENAME_NH);
            callablestatement.setInt(1,a_NhId);
            callablestatement.setString(2,a_newNhName);
            int result = callablestatement.executeUpdate();
        }
        catch( SQLException sql ) 
		{
            ...
            if ( sql.getErrorCode() == 2627 ) 
			{
                throw new BoardwalkException( 10016, sql );
            }
            else 
			{
                sql.printStackTrace();
