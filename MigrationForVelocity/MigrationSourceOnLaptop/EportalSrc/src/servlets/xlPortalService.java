...
public class xlPortalService extends xlService implements SingleThreadModel
{
...
// Update __COLLAB_STRUCTURE				70
		...
		if (bwcon != null)
		{
			System.out.println("Successfully obtained authenticated Boardwalk Connection in xlPortalService");
			System.out.println("xlPortalService inside bwcon ...Action=" + action);
...
*/
					...
					case 64:				// Get NH Hierarchy Tree for Neighborhood Administrator 
						...
						try
						{
							...
							//responseBuffer = "SUCCESS" + Seperator +  "The Neighborhood of " + nhId + "is \n" + tree + ContentDelimeter + nhId  ;
							responseBuffer = "SUCCESS" + Seperator + NhAdminTree + ContentDelimeter + userName  ;
						}
						catch (Exception e)
						{
