...
import com.boardwalk.table.TableViewManagerJsonAPI;
...
public class xlImportChangesServiceJsonAPI extends xlServiceJsonAPI implements SingleThreadModel
{
		...
		HttpServletResponse response)throws ServletException, IOException
	{
		...
		try
		{
			...
			if(bjr.jsonreader("ColumnData").length>1)
			{
