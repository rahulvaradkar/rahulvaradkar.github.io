...
public class BW_Neighborhoods extends BWServlet
{
    ServletContext sc;
	        ...
	        try {
	            ...
	            for (int i=0;i<members.length;i++)
	            {
					int userIdForMember = -1;
					  ...
					  String query = "SELECT USER_ID FROM BW_MEMBER WHERE ID = '"+memberId+"'";
					try {
	    ...
	    public void nhMembers() throws ServletException, IOException {
	     ...
	     //       System.out.println(" nhMembers for " + selNhid );
	         ...
	         //       System.out.println("User Id " + userId + " memberId " + memberid);
	                ...
	                Hashtable nhMembers = MemberManager.
	                      getMembersWithUsernameForNeighborhood(connection, selNhid);
	                if (!isMbrofNH)
	                {
