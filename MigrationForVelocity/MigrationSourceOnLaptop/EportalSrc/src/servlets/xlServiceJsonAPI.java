 ...
 */
public abstract class xlServiceJsonAPI extends HttpServlet implements SingleThreadModel
{
...
//			wout.close(); 
	...
	protected void commitResponseBuffer(String buffer, ServletResponse response) throws IOException 
	{
		...
		System.out.println("Compressed Response Buffer : Size = " + b64String.length());
		//commented by g2 050616
		//System.out.println("xlServiceJsonAPI"+b64String);
		try{
		servletOut.print(b64String);
		servletOut.flush();
		}catch(Exception e){
			System.out.println("xlServiceJsonAPI exception"+e);
			e.printStackTrace();
		}
		System.out.println("xlServiceJsonAPI before close");
		servletOut.close();
		System.out.println("xlServiceJsonAPI after close");
	}
